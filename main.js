...
function nextLevel() {
  if (curLevel < maxLevel) {
    ...
    errorMsg.innerHTML =
      "Aby odblokować kolejny poziom najpierw przejdź obecny";
    setTimeout(clearErrorMsg, 2000);
  }
}
...
function checkIntersection(r1, r2) {
  if (r1.gameNmr == r2.gameNmr) {
    if (r1.x > r2.x + r2.width) {
      if (r2.type == 2) objective(false, r1.type);
      return false;
...
function setupLvl(level) {
  ...
  if (level == 3) {
    interactives.push(new InteractiveObject(100, 102, 50, 50, 0, 0, 0));
    borders.push(
      new Border(1100, 150, 10, 520, 3, 0, interactives[0], "black")
    );

    interactives.push(new InteractiveObject(100, 102, 50, 50, 1, 1, 0));
    borders.push(
      new Border(1100, 150, 10, 520, 3, 1, interactives[1], "black")
    );
  ...
  if (level == 5) {
    ...
    player.y = 0;
    interactives.push(new InteractiveObject(100, 102, 50, 50, 1, 1, 0));
    interactives.push(new InteractiveObject(1200, 150, 50, 20, 0, 1, 1));
    borders.push(new Border(0, 350, 300, 10, 1, 0, null, "black"));
    borders.push(new Border(900, 350, 400, 10, 1, 0, null, "black"));
    borders.push(new Border(900, 170, 400, 10, 1, 0, null, "black"));
    borders.push(new Border(900, 170, 10, 180, 3, 0, null, "blue"));
    borders.push(new Border(900, 0, 10, 170, 3, 0, interactives[0], "red"));
    borders.push(new Border(450, 280, 100, 10, 1, 0, null, "black"));
    borders.push(new Border(280, 160, 100, 10, 1, 0, null, "black"));
    borders.push(new Border(480, 130, 100, 40, 1, 0, null, "black"));

    borders.push(new Border(0, 350, 300, 10, 1, 1, null, "black"));

    borders.push(new Border(900, 350, 400, 10, 1, 1, null, "black"));
    borders.push(new Border(900, 170, 400, 10, 1, 1, null, "black"));
    borders.push(new Border(900, 170, 10, 180, 3, 1, interactives[1], "blue"));

    borders.push(new Border(620, 210, 100, 30, 1, 1, null, "black"));
    borders.push(new Border(480, 280, 100, 30, 1, 1, null, "black"));
    borders.push(new Border(380, 150, 100, 30, 1, 1, null, "black"));
    borders.push(new Border(90, 150, 200, 30, 1, 1, null, "black"));
...
function drawTips() {
  ...
  if (showTips) {
    switch (curLevel) {
      case 1: {
        context.fillText(
          "Witajcie w grze. Waszym zadaniem jest dotrzeć do zielonych pól. Powodzenia!",
          400,
          30,
          1280
        );
      ...
      case 2: {
        context.fillText(
          "Zręczność to nie wszystko. Mimo, że metę symbolizuje zawsze ten sam kolor znalezienie jej nie musi byc takie łatwe. Wskazówka: współpracujcie",
          100,
          30,
          1280
        );
      ...
      case 3: {
        context.fillText(
          "W grze występują obiekty interaktywne. Rozpoznasz je po innym kolorze. Kliknij klawisz E gdy jesteś obok nich, aby aktywować mechanizm!",
          120,
          30,
          1280
        );
        context2.fillText(
          "W grze występują obiekty interaktywne. Rozpoznasz je po innym kolorze. Kliknij klawisz . gdy jesteś obok nich, aby aktywować mechanizm!",
          120,
          30,
          1280
        );
      ...
      case 4: {
        context.fillText(
          "Gra ma jeszcze jedną dość ważną mechanikę. Spróbuj ją odkryć!",
          400,
          30,
          1280
        );
